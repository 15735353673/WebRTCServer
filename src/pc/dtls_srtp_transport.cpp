/*************************************************************************
	> File Name: src/pc/dtls_srtp_transport.cpp
	> Author: lingye
	> Mail: 15735353673@163.com 
	> Created Time: Sun 03 Aug 2025 07:44:48 PM CST
 ************************************************************************/
...
namespace xrtc
{
	...
	int DtlsSrtpTransport::send_rtp(const char* buf, size_t size) {
		...
		packet.SetSize(len);
		return _rtp_dtls_transport->send_packet((char*)packet.cdata(), packet.size());
