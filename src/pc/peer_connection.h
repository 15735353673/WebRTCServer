/*************************************************************************
	> File Name: peer_connection.h
	> Author: lingye
	> Mail: 15735353673@163.com 
	> Created Time: Sat 12 Jul 2025 11:51:46 AM CST
 ************************************************************************/
...
namespace xrtc
{
	...
	public:
		...
		SessionDescription* loacl_desc() {return _local_desc.get();}
	...
	private:
		...
		TimerWatcher* _destory_timer = nullptr;
		friend void destory_timer_cb(EventLoop* ,TimerWatcher*,void* data);
