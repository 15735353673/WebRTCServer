/*************************************************************************
	> File Name: peer_connection.cpp
	> Author: lingye
	> Mail: 15735353673@163.com 
	> Created Time: Sat 12 Jul 2025 11:57:19 AM CST
 ************************************************************************/
...
namespace xrtc
{
	...
	PeerConnection::PeerConnection(EventLoop* el,PortAllocator* allocator):_el(el),
	...
	void destory_timer_cb(EventLoop* ,TimerWatcher*,void* data)
	{
	...
	void PeerConnection::destroy()
	{
		...
		_destory_timer = _el->create_timer(destory_timer_cb, this,false);
		_el->start_timer(_destory_timer,10000); // 10ms
	}
