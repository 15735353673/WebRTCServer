...
enum class IceTransportChannelState
{
	k_new,
	k_checking,
	k_connected,
...
public:
	...
	IceTransportChannelState state() {return _state;}
...
private:
	...
	IceTransportChannelState _compute_ice_transport_state();
...
private:
	...
	IceTransportChannelState _state = IceTransportChannelState::k_new;
