/*************************************************************************
	> File Name: src/pc/srtp_session.h
	> Author: lingye
	> Mail: 15735353673@163.com 
	> Created Time: Sun 03 Aug 2025 09:18:44 PM CST
 ************************************************************************/
#ifndef _SRTP_SESSION_H_
#define _SRTP_SESSION_H_
#include<iostream>
#include<vector>
	...
	private:
		bool _set_key(int type,int cs, const uint8_t* key,size_t key_len,
		 ...
		 bool _update_key(int type, int cs, const uint8_t* key, size_t key_len,
            const std::vector<int>& extension_ids);
		void _decrement_libsrtp_usage_count_and_maybe_deinit() ;
